...
def main(haz_path, rp_path, op_path, info_path, output_path):
    ...
    Example usage:
        ...
        python workflow/scripts/depth_interpolation.py \
            ...
            --output_path ~/Desktop/DataFolders/JBA_flooding/processed_data/event_depths/500_13_33579/ObsEvents/
    """
    crs = "EPSG:4326"
...
def interpolate_event_exposure(event_zones, exposure_points, hazard_prefix, output_dir):
...
def event_depths(event_id, event_zones, exposure_points, hazard_prefix, output_dir):
